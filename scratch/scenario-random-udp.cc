...
NS_LOG_COMPONENT_DEFINE ("ScenarioRandomUdp");

class ScenarioRandomUdp
{
public:
  ScenarioRandomUdp ();
...
{
  ScenarioRandomUdp test;
  uint32_t nWifis = 25;
  uint32_t nSinks = 5;
  uint32_t nSources = 5;

  double totalTime = 600.0;
  double dataStart = 300.0;
  ...
  test = ScenarioRandomUdp ();
  test.CaseRun (nWifis, nSinks, nSources, totalTime, rate, dataStart, CSVfileName, topoFileName, pairFileName, startFileName, durationFileName, animationFileName);

  return 0;
}

ScenarioRandomUdp::ScenarioRandomUdp ()
{
}

void
ScenarioRandomUdp::CheckThroughput ()
{
...
void
ScenarioRandomUdp::CaseRun (uint32_t nWifis, uint32_t nSinks, uint32_t nSources, double totalTime, std::string rate,
                           ...
                           std::string animationFileName)
{
  ...
  Simulator::Schedule (Seconds(m_totalTime),&ScenarioRandomUdp::CheckThroughput,this);
...
void
ScenarioRandomUdp::SetupMobility ()
{
...
void
ScenarioRandomUdp::CreateDevices ()
{
...
void
ScenarioRandomUdp::InstallInternetStack ()
{
  ClickInternetStackHelper click;
  click.SetClickFile (nodes, "nsclick-dsdv-0.click");
...
void
ScenarioRandomUdp::InstallApplications ()
{
