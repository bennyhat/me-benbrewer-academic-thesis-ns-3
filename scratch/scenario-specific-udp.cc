...
NS_LOG_COMPONENT_DEFINE ("ScenarioSpecificUdp");

class ScenarioSpecificUdp
{
public:
  ScenarioSpecificUdp ();
...
ScenarioSpecificUdp::ScenarioSpecificUdp ()
{
}

void
ScenarioSpecificUdp::CheckThroughput ()
{
...
void
ScenarioSpecificUdp::CaseRun (uint32_t nWifis, uint32_t nSinks, uint32_t nSources, double totalTime, std::string rate,
                           ...
                           std::string animationFileName, std::string clickFile)
{
  ...
  Simulator::Schedule (Seconds(m_totalTime),&ScenarioSpecificUdp::CheckThroughput,this);
...
void
ScenarioSpecificUdp::CreateFile ()
{
...
void
ScenarioSpecificUdp::CreateNodes ()
{
...
void
ScenarioSpecificUdp::SetupMobility ()
{
...
void
ScenarioSpecificUdp::CreateDevices ()
{
...
void
ScenarioSpecificUdp::InstallInternetStack ()
{
...
void
ScenarioSpecificUdp::InstallApplications ()
{
