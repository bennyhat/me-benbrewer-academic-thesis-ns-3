...
NS_LOG_COMPONENT_DEFINE ("StatsVoiceTxop");

class StatsVoiceTxop
{
public:
  StatsVoiceTxop ();
...
StatsVoiceTxop::StatsVoiceTxop ()
{
}

void
StatsVoiceTxop::CheckThroughput ()
{
...
void
StatsVoiceTxop::CaseRun (uint32_t nWifis, uint32_t nSinks, uint32_t nSources, double totalTime, std::string rate, std::string constRate,
                           ...
                           std::string animationFileName)
{
  ...
  Simulator::Schedule (Seconds(m_totalTime),&StatsVoiceTxop::CheckThroughput,this);
...
void
StatsVoiceTxop::InstallInternetStack ()
{
  ClickInternetStackHelper click;
  click.SetClickFile (nodes, "nsclick-dsdv-pett-voice.click");
...
void
StatsVoiceTxop::InstallApplications ()
{
